...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-primary bg-secondary topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    <div class="card new-alert alert-info">
                        <span>Selamat Datang di Sistem Informasi Manajamen Koperasi</span>
                    </div>
                        @if ($errors->any())
