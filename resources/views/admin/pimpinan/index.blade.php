            ...
            <table class="table table-bordered" id="datawidth" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th width="12%" style="text-align:center; vertical-align: middle;">Jabatan</th>
        ...
        <div class="modal-dialog" role="document">
            ...
            <form action="#" method="POST" id="compose-form" enctype="multipart/form-data">
                ...
                <div class="modal-body"> 
                    ...
                    <div class="form-group">
                        <label>Level</label>
                        <input type="text" name="level" class="form-control" value="Pimpinan" readonly>
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a class="btn btn-danger btn-hapus" data-id="' + data + '" data-handler="pimpinan" href="<?= url('admin/pimpinan/delete') ?>/' + data + '">\
                        <i class="fa fa-trash"></i> </a> \
					    <form id="delete-form-' + data + '-pimpinan" action="<?= url('admin/pimpinan/delete') ?>/' + data + '" \
        ...
        $.ajax({
            ...
            success: function (dataResult) { 
                ...
                $.each(resultData,function(index,row){
                    jQuery("#compose-form input[name=nip]").val(row.nip);
                    jQuery("#compose-form input[name=nama]").val(row.name);
                    jQuery("#compose-form input[name=email]").val(row.email);
                    jQuery("#compose-form input[name=jabatan]").val(row.jabatan);
