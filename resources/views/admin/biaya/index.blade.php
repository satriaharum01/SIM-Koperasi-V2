...
<script>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a class="btn btn-danger btn-hapus" data-id="' + data + '" data-handler="biaya" href="<?= url('admin/biaya/delete') ?>/' + data + '">\
                        <i class="fa fa-trash"></i> </a> \
					    <form id="delete-form-' + data + '-biaya" action="<?= url('admin/biaya/delete') ?>/' + data + '" \
    ...
    function kosongkan()
    {
        jQuery("#compose-form input[name=tanggal]").val("{{date('Y-m-d')}}");
