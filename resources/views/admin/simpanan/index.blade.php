            ...
            <table class="table table-bordered" id="datawidth" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th width="25%" style="text-align:center; vertical-align: middle;">No HP</th>
                        <th style="text-align:center; vertical-align: middle;">Jumlah Simpanan</th>
    ...
    $(function() {
        table = $('#datawidth').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'simpanan', render: function(data){
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return '<a class="btn btn-primary" data-id="' + data + '"  href="<?= url('admin/simpanan/detail') ?>/' + data + '">\
